...
export default function ManageUsers() {
  ...
  return (
    <div className="flex min-h-screen">
      <Sidebar />
      <div className="flex-1 w-[60%] flex flex-col h-screen overflow-hidden">
        <Header />
          ...
          >
            <div className="p-4 flex justify-between items-center border-b">
              ...
              <button
                ...
                className="!text-white !hover:text-gray-700 !px-3 !py-2"
              >
                ✕
              </button>
            </div>
            ...
            <div className="p-4 space-y-4 text-black overflow-y-auto max-h-[calc(100vh-64px)]">
              <div>
                ...
                <DatePicker
                  selected={
                    tempFilters.from ? new Date(tempFilters.from) : null
                  }
                  onChange={(date) =>
                    setTempFilters({
                      ...tempFilters,
              ...
              <div className="flex justify-between mt-4">
                <button
                  ...
                  className="!px-3 !text-sm !py-2 !bg-gray-500 !text-white rounded"
                >
                  Clear
                </button>
                ...
                <button
                  ...
                  className="!px-3 !text-sm !py-2 !bg-blue-600 !text-white rounded "
                >
                  Apply
                </button>
              </div>
